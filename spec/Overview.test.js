...
import Overview from '../client/src/components/Overview/SM-Overview.jsx';
import Price from '../client/src/components/Overview/SM-Price.jsx';
...
beforeEach(() => {
  act(() => {
    render(<Overview url={'42366'} />);
  });
});
  test('renders Overview page', async () => {

    const overview = await waitFor(() => screen.getByTestId('Overview1'));
    expect(overview).toBeInTheDocument();
  });
});

test('it renders given price', () => {
